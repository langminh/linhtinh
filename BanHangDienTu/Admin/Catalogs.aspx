            ...
            <div class="col-md-8">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <asp:ListView ID="catalogList" runat="server" OnPagePropertiesChanging="catalogList_PagePropertiesChanging">
                            <LayoutTemplate>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><%# Eval("Name") %></td>
                                    <td class="last">
                                        <asp:LinkButton runat="server" CssClass="edit-delete" Text="Sửa" ID="Update" OnClick="Update_Click"></asp:LinkButton>
                                        | 
                                        <asp:LinkButton runat="server" CssClass="edit-delete" Text="Xóa" ID="Dellete" OnClick="Delete_Click"></asp:LinkButton>
                                    </td>
